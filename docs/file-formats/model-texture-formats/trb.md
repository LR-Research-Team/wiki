...
| Offset | Size | Type | Description |
| --- | --- | --- | --- |
| 0x0 | 0x30 | [SectionHeader](#section-header)| The header of this section |
...
| 0x40 | 0x10 x Subsection count | [Subsection Definition](#subsection-definition)[Subsection count] | Subsection offsets and lengths |
...
| GTEX Chunk Offset | Variable | [GTEX](#gtex)| GTEX Chunk |
...
| 0x9 | 0x1 | UInt8 | [Texture type](#texture-type) |
...
| Mip Info Offset | 0x8 x Mipmap Count | [Mipmap Specs](#mipmap-specs)[Mipmap Count] | The mipmaps' information |
...
| --- | --- | --- | --- |
| 0x0 | 0x30 | [SectionHeader](#section-header)| The header of this section |
| 0x30 | Variable | [SHD](#shd) | SHD Chunk |
...
| --- | --- | --- | --- |
| 0x0 | 0x30 | [SectionHeader](#section-header)| The header of this section |
| 0x30 | Variable | [WPDContainer](#wpd-container) | Beginning of a WPD Container |
...
| 0x10 | 0x20 | [WPDRecord](#wpd-record)[Record count] | WPD record definitions |
...
| Offset | Size | Type | Description |
| --- | --- | --- | --- |
| 0x00 | 0x10 | [STMS Header](#stms-header) | Buffer Data Definition |
| 0x10 | [STMS Header]Attribute Count x 0x10 | [Attribute Info](#attribute-info)[Attribute count] | Attribute properties to parse the buffer |
...
| 0x38 | 0x28 x Section count| [Remote Section](#remote-section-data)[Section count] | Section data|
| 0x38 + 0x28 x Section count| 0x20 | [Model Reference](#model-reference)[Model count] | Linked model names |
...
| --- | --- | --- | --- |
| 0x0 | 0x30 | [SectionHeader](#section-header)| The header of this section |
| 0x30 | Variable | [WRB](#wrb) | WRB Chunk |
...
| 0x40 | Subsections count * 0x10 | [SKL Subsection Header](#skl-subsection-header)[Subsections count] | Subsections' headers |
| Variable | Variable | [SKL Subsections](#skl-subsection) | The actual subsections|
...
| Offset | Size | Type | Description |
| --- | --- | --- | --- |
| 0x0 | 0x10 | [Chunk Header](#chunk-header) | Chunk Header |
...
| --- | --- | --- | --- |
| 0x0 | 0x10 | [Chunk Header](#chunk-header) | Chunk Header |
| 0x10 | 0x10 | [STMS Header](#stms-header) | Buffer Data Definition |
| 0x20 | [STMS Header]Attribute Count x 0x10 | [Attribute Info](#attribute-info)[Attribute count] | Attribute properties to parse the buffer |
| 0x20 + [STMS Header]Attribute Count x 0x10 | [STMS Header]Entry Count x [STMS Header]Stride | Variable | Buffer - May not be present if trb data is found in another file. See [SEDBmsst](#sedbmsst)|
...
| 0x4 | 0x4 | UInt32 | [Data type](#data-type)|
| 0x8 | 0x4 | UInt32 | Count |
| 0xC | 0x2 | UInt16 | [Semantic](#semantic) |
...
| Offset | Size | Type | Description |
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | Variable | [FILE[Count depending on the game]](#file) | FILE Chunks |
| Variable | 0x20 | [VCAP](#vcap) | VCAP Chunk |
| Variable | 0x90 | [PCAP](#pcap) | PCAP Chunk |
| Variable | Variable | [PRAM](#pram) | PRAM Chunk |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | Variable | [MDLC](#mdlc) | MDLC Chunk Container |
| Variable | 0x40 | [LTCD](#ltcd) | LTCD Chunk Container |
| Variable | Variable | [MICT](#mict) | MICT Chunk Container |
| Variable | 0x70 | [PESR](#pesr) | PESR Chunk Container (not always present)|
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x30 | [MDLC Header Chunk](#mdlc-header) | MDLC Header Chunk |
| 0x50 | Variable | [MDL Chunk](#mdl)[Variable count] | MDL Chunk Containers (count given in the MDLC Header chunk)|
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | Variable | [Name Chunk](#name) | The MDL name |
| Variable | 0x30 | [MDL Header Chunk](#mdl-header) | MDL Header Chunk |
| Variable | Variable | [MESH Chunk](#mesh)[Variable count] | MESH Chunk Containers (count given in the MDLC Header chunk)|
| Variable | 0x80 | [AABB Chunk Container](#aabb-container) | The MDL's bounding box and scale/bias info |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x20 | [MESH Header Chunk](#mesh-header) | MESH Header Chunk |
| 0x40 | Variable | [STR Chunk](#str) | This chunk defines the shader used for this submesh, giving its name.|
| Variable | 0x20 | [RSID Chunk](#rsid) | External resource name info |
| Variable | 0x20 | [RSTP Chunk](#rstp) | External resource type info |
| Variable | 0x20 | [PRID Chunk](#prid) | External resource source file location info |
| Variable | 0x20 | [PRTP Chunk](#prtp) | External resource file type info |
| Variable | Variable | [STMS](#stms)[Variable count] | STMS Chunks (count given in the MESH Header chunk)|
| Variable | 0x20 | [MPR](#mpr)[Variable count] | MPR Chunks (not always present, count given in the MESH Header chunk)|
| Variable | 0x20 | [MDR](#mdr)[Variable count] | MDR Chunks (not always present, count given in the MESH Header chunk)|
| Variable | Variable | [ENVD](#envd)[Variable count] | ENVD Chunks (count given in the MESH Header chunk)|
| Variable | 0x50 | [AABB Chunk Container](#aabb-container) | The mesh's bounding box info |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x30 | [AABB Chunk](#aabb-comp)[Variable count] | AABB Chunk |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x10 | [LTCD Header Chunk](#ltcd-header) | LTCD Header Chunk |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | Variable | [MINS Chunk](#mins)[Variable count] | MINS Chunk Containers, which count is always equal to the number of MDL in the MDLC Chunk Container.|
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x40 | [MINS Header Chunk](#mins-header) | MINS Header Chunk |
| 0x60 | Variable | [NAME Chunk](#name) | Associated Skeleton Joint Name |
...
| --- | --- | --- | --- |
| 0x0 | 0x20 | [Chunk Container Header](#chunk-container-header) | Chunk Container Header |
| 0x20 | 0x50 | [PESH Chunk](#pesh)[Variable count] | PESH Chunk |

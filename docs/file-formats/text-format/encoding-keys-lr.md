This page contains encoding keys used only by LIGHTNING RETURNS FINAL FANTASY XIII.

### Color keys

The color keys indicate the color with which a particular portion of text is displayed ingame in LIGHTNING RETURNS FINAL FANTASY XIII. 
<br>Please refer to the image given below, to get a better idea on how the colors would look like when its displayed ingame. 

<br>![Image](../../assets/ztr/xiiilr_ztr_colors.png)
...
![Image](../../assets/ztr/xiiilr_ztr_icons.png)
